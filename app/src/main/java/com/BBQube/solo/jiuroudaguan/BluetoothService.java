...
public class BluetoothService {
    ...
    public synchronized void connect(BluetoothDevice device, boolean secure) {
       ...
       // }
        ...
        mConnectThread.start();  // run() method of ConnectThread Thread Class will be called. If successfully connected, then the Connected Thread will be called
        ...
        public AcceptThread(boolean secure) {
            ...
            try {
                if (secure) {
                    ...
                    // tmp = InsecureBluetooth.listenUsingRfcommWithServiceRecord(mAdapter, NAME_INSECURE, MY_UUID_INSECURE, true);
                }
            } catch (IOException e) {
            ...
            try {
                if (secure) {
                    ...
                    tmp = device.createRfcommSocketToServiceRecord(
                            MY_UUID_SECURE);
                    Log.d(TAG, "createRfcommSocketToServiceRecord over");
                } else {
                    Log.d(TAG, "insecure!!!!!");
                    tmp = device.createInsecureRfcommSocketToServiceRecord(
                            MY_UUID_INSECURE);
                    // tmp = InsecureBluetooth.createRfcommSocketToServiceRecord(device, MY_UUID_INSECURE, true);

                    Log.d(TAG, "createInsecureRfcommSocketToServiceRecord over");
                }
            } catch (IOException e) {
